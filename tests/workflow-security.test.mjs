...
test("v1.5.0 release inputs contain proportional-engineering and execution-evidence assets", () => {
  const packageJson = JSON.parse(readFileSync(join(root, "package.json"), "utf8"));
  ...
  assert.deepEqual(releaseCatalog.releases.map(({ version }) => version), ["1.0.0", "1.1.1", "1.2.0", "1.3.0", "1.4.0"]);
  ...
  for (const path of [
    ...
    "adapters/codex/skills/architecture-review/SKILL.md",
    "adapters/codex/skills/change-scope-review/SKILL.md",
    ...
    "adapters/claude-code/commands/architecture-review.md",
    "adapters/claude-code/commands/change-scope-review.md",
